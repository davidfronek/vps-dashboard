...
import { Database, HardDrive, Plus, RefreshCw, Search, ShieldCheck, TableProperties, Trash2, UserRound, X } from "lucide-react";
...
export default function DatabaseView({ databases, onRefresh, runJob }: { databases: PostgreSqlDatabase[]; onRefresh: () => void; runJob: JobRunner }) {
  ...
  const [managedDatabase, setManagedDatabase] = useState("");
